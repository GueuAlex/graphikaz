  ...
  return (
    <div className="error-404-view">
      <div className="wrapper">
        <div className="error-text-container flex flex-col text-center w-full">
          <span>Oops</span>
          <p>
            Nous sommes désolés, mais le service que vous recherchez n'a pas été
            trouvé.
            <br />
            Il se peut qu'il ait été déplacé, supprimé ou qu'il n'ait jamais
            existé.
          </p>
        </div>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 980">
          <title>404</title>
