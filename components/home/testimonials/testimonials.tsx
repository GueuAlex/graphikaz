  ...
  return (
    <div className="testimonials px-[2rem] py-[5rem] w-full flex justify-center items-start">
      <div className="max-w-[97rem] h-full w-full flex flex-col justify-center items-center">
        <h2 className=" text-slate-800">Testimonials</h2>
        ...
        <div className="flex flex-col justify-center items-center text-testi">
          <h2 className=" text-slate-800 text-center max-w-[65rem] font-normal">
            "Sed ut prespiciatis unde omnis iste natus error sit voluptatem
            accusaatium doloremque laudantium, totam rem aperiam, eaque ipsa
            quae ad illo inventore veritatis"
          </h2>
          <h3 className="mt-10">Ali Tufan</h3>
          <small className=" text-stone-600 mt-2">
