    ...
    <div className="t-services w-full px-[2rem] py-[5rem] bg-primary relative  flex justify-center items-center">
       <div className="max-w-[97rem] relative   w-full">
            ...
            <div className="px-[5px] py-[5px] relative">
                <div className="w-[2.5rem] h-[2.5rem] hover:bg-secondary hover:text-white cursor-pointer bg-white opacity-80 absolute z-[100] rounded-full shadow shadow-slate-600 top-1/2 flex justify-center items-center"><i className="ri-arrow-left-s-line text-[1.5rem]"></i></div>
                <div className="w-[2.5rem] h-[2.5rem]  hover:bg-secondary hover:text-white cursor-pointer bg-white opacity-80 absolute z-[100] rounded-full shadow shadow-slate-600 right-0 top-1/2 flex justify-center items-center"><i className="ri-arrow-right-s-line text-[1.5rem]"></i></div>
