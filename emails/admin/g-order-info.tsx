...
export const GOrderInfo = ({
  ...
  return (
    <Html>
      ...
      <Preview>
        {userName
          ? `${userName} à passer une nouvelle commande`
          : "Reception d'une nouvelle commande"}
      </Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={message}>
            <Img
              ...
              style={{ margin: "auto" }}
            />
            <Heading style={global.heading}>Nouvelle commande</Heading>
          ...
          >
            <Row>
              <Column>
                <Text style={adressTitle}>Client(e)</Text>
                <Text style={{ ...global.text, fontSize: 14 }}>{userName}</Text>
              </Column>
              <Column style={{ textAlign: "right" }}>
                <Text style={adressTitle}>Contacts</Text>
          ...
          {/* <Hr style={global.hr} /> */}
          <Heading style={{ ...global.heading, fontSize: "20px" }}>
            {serviceTitle}
          </Heading>
          ...
          <Section style={{ padding: "10px" }}>
            ...
            >
              ...
              >
                ...
                <small style={{ fontWeight: "600" }}>Delai de livraison</small>
                <Text style={global.text}>{deliveryDelai} jour(s)</Text>
              </Column>
            </Row>
          </Section>
          {/* Facture */}
...
GOrderInfo.PreviewProps = {
  userName: "John Doe",
  paiementEmail: "John.Doe@gmail.com",
  paiementPhoneNumber: "070000000000",
  deliveryDelai: "3",
