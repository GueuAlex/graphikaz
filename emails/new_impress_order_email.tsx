...
export const NewImpressOredEmail = ({}: OrderEmailProps) => {
  return (
    <Html>
      <Head />
      <Preview>
        ...
        <Container style={container}>
          ...
          <Section style={message}>
            ...
            <Text style={{ ...global.text, marginTop: 24 }}>
              ...
              votre commande. Pour plus d'informations sur le paiement,
              consultez votre page Commandes sur graphikaz.com
            </Text>
          </Section>
          <Hr style={global.hr} />
...
NewImpressOredEmail.PreviewProps = {
  validationCode: "567860",
} as OrderEmailProps;

export default NewImpressOredEmail;
