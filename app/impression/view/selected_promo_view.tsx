...
interface SecletedFlyerViewProps {
  selectedPromo: PromotionalProps;
  setSelectedPromo: (selectedPromo: PromotionalProps | undefined) => void;
}
const SecletedPromoView: React.FC<SecletedFlyerViewProps> = ({
  selectedPromo,
  setSelectedPromo,
}) => {
  const promos = promostionals.filter(
    (promo) => promo.product === selectedPromo.product
  );
  const paragraphs = selectedPromo.short_description.split("\n");
  ...
  const order: ImpressOrderProps = {
    ...
    impressable: selectedPromo.title,
    impressable_format: selectedPromo.format,
    impressable_type: selectedPromo.type,
    ordering_at: null,
    quantity: quantity,
    amount: totalPrice,
    ...
    <div className="selected-flyer-container">
        ...
        <div className="flyer-details ">
          <div className="flyer-details-left  flex-1">
            <div className="sticky-left ">
              <div className="cover-container w-full relative">
                <div
                  className="go-back"
                  onClick={() => setSelectedPromo(undefined)}
                >
                  {"<- Retour"}
                </div>
                <Image src={selectedPromo.cover} alt={selectedPromo.title} />
              </div>
                  ...
                  {promos.map((flyer) => (
                    <div
                      className={`unselected-f ${
                        flyer.id === selectedPromo.id ? "active" : ""
                      }`}
                      onClick={() => setSelectedPromo(flyer)}
                    >
          ...
          <div className="flyer-details-right flex-1">
            ...
            <div className="customisation">
              <h1>Customiser votre flyers {selectedPromo.title}</h1>
      ...
      <div className="selected-flyer-desc">
        <div className="desc-container">
          <h2>Concernant {selectedPromo.title}</h2>
          <div className="descripter">
            ...
            <div className="full-desc">
              {selectedPromo.full_description.map((desc) => {
          ...
          <div className="descripter">
            ...
            <div className="">
              <ul className="px-[16px]">
                {selectedPromo.caracteristics.map((caract) => (
...
export default SecletedPromoView;
