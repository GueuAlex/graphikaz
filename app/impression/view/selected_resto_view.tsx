...
interface SecletedRestoViewProps {
  selectedResto: RestoProps;
  setSelectedFlyer: (selectedResto: RestoProps | undefined) => void;
}
const SecletedRestoView: React.FC<SecletedRestoViewProps> = ({
  selectedResto,
  setSelectedFlyer,
}) => {
  const unselectedResto = menusResto.filter(
    (resto) => resto.type === selectedResto.type
  );
  const paragraphs = selectedResto.short_description.split("\n");
  ...
  const order: ImpressOrderProps = {
    ...
    impressable: selectedResto.title,
    impressable_format: selectedResto.format,
    impressable_type: selectedResto.type,
    ordering_at: null,
    quantity: quantity,
    amount: totalPrice,
    ...
    <div className="selected-flyer-container">
        ...
        <div className="flyer-details ">
          <div className="flyer-details-left  flex-1">
            <div className="sticky-left ">
              <div className="cover-container w-full relative">
                ...
                <Image src={selectedResto.cover} alt={selectedResto.title} />
              </div>
              <div className="unselected-container">
                <h3>SÉLECTIONNER UN STYLE DE FLYERS</h3>
                <div className="unseleted-content w-full">
                  {unselectedResto.map((resto) => (
                    <div
                      key={resto.title}
                      className={`unselected-f ${
                        resto.id === selectedResto.id ? "active" : ""
                      }`}
                      onClick={() => setSelectedFlyer(resto)}
                    >
          ...
          <div className="flyer-details-right flex-1">
            ...
            <div className="customisation">
              <h1>Customiser votre flyers {selectedResto.title}</h1>
      ...
      <div className="selected-flyer-desc">
        <div className="desc-container">
          <h2>Concernant {selectedResto.title}</h2>
          <div className="descripter">
            ...
            <div className="full-desc">
              {selectedResto.full_description.map((desc, index) => {
          ...
          <div className="descripter">
            ...
            <div className="">
              <ul className="px-[16px]">
                {selectedResto.caracteristics.map((caract, index) => (
...
export default SecletedRestoView;
