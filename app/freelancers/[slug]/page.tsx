...
const SingleFreelancer = ({ params }: { params: { slug: string } }) => {
  ...
  const prestator: PrestatorProps | undefined = prestators.find(
    (prestator) => prestator.fullName === prestatorName
  );
  ...
  if (prestator) {
                ...
                <div className="desc-head flex justify-between ">
                  <div className="desc flex items-center gap-2">
                    <div className="icon-large relative">
                      <i className="ri-focus-2-line text-[2.8em] text-primary"></i>{" "}
                  ...
                  <div className="desc flex items-center gap-2">
                    <div className="icon-large relative">
                      <i className="ri-line-chart-line text-[2.8em] text-primary"></i>{" "}
                      <div className="transparant absolute"></div>
                    </div>
                    <div className="desc-text">
                  ...
                  <div className="desc flex items-center gap-2">
                    <div className="icon-large relative">
                      <i className="ri-checkbox-multiple-line text-[2.8em] text-primary"></i>{" "}
                      <div className="transparant absolute"></div>
                    </div>
                    <div className="desc-text">
                  ...
                  <div className="desc flex items-center gap-2">
                    <div className="icon-large relative">
                      <i className="ri-hourglass-fill text-[2.8em] text-primary"></i>{" "}
                      <div className="transparant absolute"></div>
                    </div>
                    <div className="desc-text">
                      <span>In Queue service</span>
                      <br />
                      <small>25</small>
                    </div>
                  </div>
                ...
                <div className="ratting-area">
                  ...
                  <div className="review-comment">
                    <span className="text-bold">
                      Be the first to review “{prestator.fullName}”
                    </span>
                    <form action="">
    ...
    return <div className="404-component">404</div>;
  }
};
            ...
            <div className="awards-contacts flex justify-between">
              <div className="awards items-center flex gap-6">
                <div className="reviews">
                  <i className="ri-star-fill text-yellow-500"></i> {4.0} {`(`}
                  {2}
                  {` Reviews)`}
                </div>
                <div className="dett">
                  <i className="ri-user-location-line"></i> Abidjan
                </div>
                <div className="dett">
                  <i className="ri-calendar-2-line"></i> September 14, 1996
                </div>
              </div>
    ...
    <div className="sticky top-0 flex flex-col gap-3">
      <div className="top-container">
        ...
        <div className="top-body">
          ...
          <div className="icon-text1-text2">
            <div className="icon-text1">
              <i className="ri-file-copy-2-line"></i> <span>Type</span>
            </div>
          ...
          <div className="icon-text1-text2">
            <div className="icon-text1">
              <i className="ri-translate"></i> <span>English Level</span>
            </div>
          ...
          <div className="icon-text1-text2">
            <div className="icon-text1">
              <i className="ri-men-line"></i> <span>Gender</span>
            </div>
          ...
          <div className="icon-text1-text2">
            <div className="icon-text1">
              <i className="ri-phone-line"></i> <span>Phone</span>
            </div>
