...
function Categories() {
  ...
  const data = ['Last Hour', 'Last 24 hours', 'Last 7 days', 'Last 14 days', 'Last 30 days', 'All'];
  ...
  /* select arrays */
  const responseTime = ['1 Hour', '2 Hours', '3 hours', '4 Hours', '5 Hours', '6 Hours', '7 Hours'];
  const deliveryTime = ['1 Day', '2 Days', '3 Days', '4 Days', '5 Days', '6 Days', '7 Days'];
    ...
    <div className="categories">
        ...
        <form>
          <div className="side-filter-container">
              ...
              <div className="filter-cat-body">
                <ul>
                  {visibleItemsD.map((data, index) =>(
                    <li>
                      <input type="radio" value={data} name="radio" id={index.toString()} />
            ...
            <div className="filter-section">
              ...
              <select name="" id="">
                <option value="" selected disabled>Response Time</option>
            ...
            <div className="filter-section">
                ...
                <div className='ranger relative'>
                  ...
                  <div className="range-inputs">
                    <input type="range" id="minRange" name="minRange" min="0" max="100" value={minValue} onChange={handleMinChange}/>
                    <input type="range" id="maxRange" name="maxRange" min="0" max="100" value={maxValue} onChange={handleMaxChange}/>
                  </div>
                </div>
            </div>
      ...
      <Wrapper>
          ...
          <div className='paginator py-[2em] gap-3'>
            ...
            <div className="next"><i className="ri-arrow-right-line"></i></div>
          </div>
      </Wrapper>
    </div>
  )
